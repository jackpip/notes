...
RSpec.describe NotesController, type: :controller do
  ...
  describe "note#create action validations" do
    before do
  ...
  describe "notes#update action" do
    ...
    it "should receive the updated note in response" do
      put :update, params: { id: @note.id, note: { title: 'Updated First', content: 'Updated note' } }
      json = JSON.parse(response.body)
      expect(json['content']).to eq('Updated note')
